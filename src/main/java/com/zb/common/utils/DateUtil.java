...
/**
 * Created by bzheng on 2018/4/19.
 */
public class DateUtil {
    ...
    public static List getTimeList(int beginYear, int beginMonth, int endYear,
        ...
        if (beginYear == endYear) {
            ...
            {
                for (int j = beginMonth; j < months; j++) {
                    list.add(getTimeList(beginYear, j, k));
                }
    ...
    /**
     * 获取某月的最后时间 (返回格式：yyyy-MM-dd 23:59:59)
     *
     * @param date   时间
     * @param months
     * @return 最后时间
     * @author Teemol
     */
    public static Date plusTerminalMonths(Date date, int months) {
    ...
    /**
     * 获取某月的开始时间 (返回格式：yyyy-MM-dd 00:00:00)
     *
     * @param date   时间
     * @param months
     * @return 最后时间
     * @author Teemol
     */
    public static Date plusBeginMonths(Date date, int months) {
    ...
    /**
     * 计算两个时间差，转成 XX时XX分XX秒格式
     *
     * @param beginDate
     * @param endDate
     * @return
     */
    public static String calTimeDiff(Date beginDate, Date endDate) {
        long beginTime = beginDate.getTime();
        long endTime = endDate.getTime();
        long diffTime = Math.abs(beginTime - endTime);
        //计算小时数
        long hours = diffTime / 3600000;
        long remain = diffTime - hours * 3600000;
        //计算分钟
        long mins = remain / 60000;
        remain = remain - mins * 60000;
        //计算秒
        long secs = remain / 1000;
        String str = hours + "时" + mins + "分" + secs + "秒";
        return str;
